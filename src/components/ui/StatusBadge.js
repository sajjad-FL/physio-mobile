...
function StatusBadge({ kind, value, bookingStatus, sessionStatus, paymentStatus, planStatus, style }) {
  ...
  if (kind === 'booking') palette = bookingStatusBadge(bookingStatus, sessionStatus, paymentStatus, planStatus)
  return (
    <Chip
      label={palette.label}
      bg={palette.bg}
