...
const styles = StyleSheet.create({
  ...
  row: { borderBottomWidth: 1, borderBottomColor: colors.borderSubtle, padding: 10 },
  rowInner: { flexDirection: 'row', gap: 10, alignItems: 'flex-start' },
  rowHead: { fontSize: 13, fontWeight: '600', color: colors.slate900, flexWrap: 'wrap' },
  tagDone: { fontSize: 11, fontWeight: '700', color: colors.emerald900 },
  tagNs: { fontSize: 11, fontWeight: '700', color: '#9f1239' },
  tagToday: { fontSize: 11, fontWeight: '700', color: colors.blue700 },
  locked: { fontSize: 10, fontWeight: '700', color: colors.slate600 },
  nsReason: { marginTop: 6, fontSize: 12, color: '#9f1239' },
  ...
  miniTxt: { fontSize: 11, fontWeight: '700', color: colors.slate800 },
  miniWarnTxt: { fontSize: 11, fontWeight: '700', color: '#9f1239' },
  disabled: { opacity: 0.45 },
  blockHint: { marginTop: 6, fontSize: 11, color: colors.slate500 },
  badge: { borderWidth: 1, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4, alignSelf: 'flex-start' },
  badgeTxt: { fontSize: 11, fontWeight: '700', color: colors.slate700 },
})
